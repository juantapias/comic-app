    ...
    <Fragment>
      <Grid container>
        <Grid item xs={12} sm={11} md={12}>
          <Typography variant="h4" className={classes.h4}>Characters</Typography>
        </Grid>
        <Grid container>
          { !data.character_credits.length
            ?
            <Grid item xs={12} sm={11} md={12}>
              <Alert variant="outlined" severity="info">No characters to show</Alert>
            </Grid>
            :
