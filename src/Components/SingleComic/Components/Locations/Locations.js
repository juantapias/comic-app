    ...
    <Fragment>
      <Grid container>
        <Grid item xs={12} sm={11} md={12}>
          <Typography variant="h4" className={classes.h4}>Locations</Typography>
        </Grid>
        <Grid container>
          { !data.location_credits.length
            ?
            <Grid item xs={12} sm={11} md={12}>
              <Alert variant="outlined" severity="info">No locations to show</Alert>
            </Grid>
            :
